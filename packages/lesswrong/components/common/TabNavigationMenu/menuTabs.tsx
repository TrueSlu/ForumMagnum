...
export const menuTabs: ForumOptions<Array<MenuTab>> = {
  LessWrong: [
    ...
    },
    {
      ...
      link: "/tags/all",
      icon: conceptsIcon,
      tooltip: <div>Get an overview over all the concepts used on LessWrong</div>,
      showOnMobileStandalone: true,
      showOnCompressed: true,
    },
    {
    ...
    },
    {
      ...
      tooltip: (
        <div>
          <p>
            LessWrong was founded by Eliezer Yudkowsky. For two years he wrote a blogpost a day about topics including
            rationality, science, ambition and artificial intelligence.
          </p>
          <p>Those posts have been edited down into this introductory collection, recommended for new users.</p>
        </div>
      ),
      subItem: true,
    },
  ...
  ProgressForum: [
    ...
    },
    {
      ...
      link: "/library",
      iconComponent: LocalLibrary,
      tooltip: "Curated collection of the Progress Forum's best writing",
      showOnMobileStandalone: true,
      showOnCompressed: true,
    },
    ...
    },
    {
      ...
      link: "/allPosts",
      iconComponent: Sort,
      tooltip: "All posts, filtered and sorted by date, karma, and more",
      showOnMobileStandalone: true,
      showOnCompressed: true,
    },
    {
